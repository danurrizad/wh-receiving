...
import { dataSchedules, dataReceiving } from '../../utils/DummyData'
...
const Dashboard = () => {
  const {setChartData, getChartOption} = useChartData()
  const options = [
    // { value: 'all', label: 'All' },
            ...
            <CCardBody>
              <CRow className='py-3'>
                <CCol className='d-flex gap-2' xxl={7} md={12}>
                  <div style={{ backgroundColor: '#FFBB00', color: "white", fontWeight: "bold", borderRadius: '5px'}} className='px-4 py-2'>SCHEDULE PLAN</div>
                  <div style={{ backgroundColor: '#F64242', color: "white", fontWeight: "bold", borderRadius: '5px'}} className='px-4 py-2'>ARRIVAL DELAY</div>
                ...
                <CCol className='d-flex gap-2 align-items-center justify-content-end'>
                    ...
                    <Select placeholder="All" isClearable className='w-50' styles={colorStyles} options={[{label: "On Schedule", value: "on_schedule"}, {label: "Delayed", value: "delayed"}]}/>
                </CCol>
              </CRow>
              <CRow className='p-3'>
                <CCard>
            ...
            <CCardBody>
              <CRow className='py-2'>
                <CCol xs={3} className='d-flex align-items-center gap-4'>
                  <div>Filter</div>
                  <Select placeholder="All" className='w-100' isClearable options={options} styles={colorStyles}/>
                </CCol>
